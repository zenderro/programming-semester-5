...
Для получения зачёта нужно сдать решения 3 задач (не считая подготовительных задач) и сдать теоретическую часть. Каждая последующая задача выдаётся после сдачи предыдущей.
...
1. В начале зачётной недели — теоретический зачёт.
2. Три практических зачёта по 3 часа. Те, кто не успел сдать задачи за эти попытки отправляются на пересдачу.
3. Во второй половине зачётной недели — второй теоретический зачёт.
...
2. Примите тестовое задание: https://classroom.github.com/a/e0R5Z3MK
